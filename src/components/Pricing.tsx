...
function Pricing() {
  ...
  return (
    <section className="w-full bg-transparent py-6 sm:py-8 md:py-10 px-2 sm:px-4">
      <div
        className="text-center text-primary-foreground bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 p-3 sm:p-4 md:p-6 lg:p-12 rounded-3xl overflow-hidden"
