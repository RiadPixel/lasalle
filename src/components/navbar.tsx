...
function Navbar() {
  ...
  return (
    <nav
      className={`w-full sticky top-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow border border-gray-300 rounded-lg mt-6 mx-auto w-[85%] top-4" : "bg-transparent top-0"}`}
    >
      <div className="mx-auto flex items-center justify-between py-3 px-4 md:px-6 w-full relative">
        ...
        <div className="hidden md:flex items-center space-x-8 flex-grow justify-start">
          <a
            href="#"
            className="text-gray-700 hover:text-purple-700 transition-colors duration-200 text-sm font-medium relative group nav-link group-[.nav-link-active]:text-purple-600"
          >
            Home
        ...
        <div className="hidden md:flex items-center space-x-4 flex-grow justify-end">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <a
              href="#"
              className="text-gray-600 hover:text-primary transition-colors duration-200 p-2 rounded-full hover:bg-primary hover:text-primary-foreground"
            >
              <Instagram size={20} />
            </a>
            <a
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-8 flex-grow">
            <a
              href="#"
              className="text-gray-800 text-3xl font-semibold hover:text-purple-700 transition-colors duration-200"
              onClick={toggleMenu}
            >
              Home
            </a>
            ...
            <button
              className="bg-purple-600 text-white hover:bg-white hover:text-purple-600 hover:border-2 hover:border-purple-600 hover:shadow-lg text-xl font-bold py-3 px-6 rounded-full transition duration-300 mt-8"
              onClick={toggleMenu}
            >
              Contact Us
            </button>
            <div className="flex space-x-6 mt-6">
              <a
                href="#"
                className="text-gray-600 hover:text-purple-700 transition-colors duration-200 p-2 rounded-full hover:bg-primary hover:text-primary-foreground"
                onClick={toggleMenu}
              >
                <Instagram size={28} />
              </a>
