...
function Navbar() {
  ...
  return (
    <nav className={`w-full sticky z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md border border-gray-300 rounded-lg mt-6 mx-auto w-[85%] top-4' : 'bg-transparent top-0'}`}>
