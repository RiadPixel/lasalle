...
function Navbar() {
  ...
  return (
    <nav className="bg-white md:bg-transparent shadow-sm md:shadow-none sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between py-3 px-4 md:px-6">
        ...
        <div className="hidden md:flex space-x-8 flex-grow justify-start items-center">
