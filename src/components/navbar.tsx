...
function Navbar() {
  ...
  return (
    <nav className={`w-full sticky z-[100] transition-all duration-300 ${scrolled ? 'bg-white shadow border border-gray-300 rounded-lg mt-4 mx-auto w-[85%] top-4' : 'bg-transparent top-0 w-full'}`}>
      <div className={`mx-auto flex items-center justify-between py-3 px-4 md:px-6 w-full relative ${scrolled ? 'py-2' : 'py-3'}`}>
        ...
        <div className="hidden md:flex items-center space-x-4 flex-grow justify-end">
          <button className="hidden md:inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity50 bg-white text-purple-600 border-2 border-purple-600 hover:shadow-lg h-10 px-8 py-2 rounded-md hover:bg-gradient-to-r from-white to-purple-600 hover:text-white">
            Reserve
          </button>
          <button className="hidden md:inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity50 bg-purple-600 text-white hover:shadow-lg h-10 px-8 py-2 rounded-md hover:bg-gradient-to-r from-purple-600 to-white hover:text-purple-600">
            Contact Us
          </button>
