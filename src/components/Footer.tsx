...
const Footer = () => {
  return (
    <div className="w-full bg-transparent py-6 sm:py-8 md:py-4 px-2 sm:px-4 flex items-end">
      <footer className="w-full bg-[#1f1f1f] text-white p-4 sm:p-6 lg:p-10 rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-white shadow-2xl relative overflow-hidden">
            ...
            <ul className="space-y-3 sm:space-y-4 text-white text-sm sm:text-base">
              {["Home", "Membership", "About", "Blog"].map((item, index) => (
                ...
                >
                  ...
                  >
                    <span className="w-0 h-0.5 bg-white transition-all duration-300 group-hover:w-3 sm:group-hover:w-4 flex-shrink-0"></span>
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 space-y-3 text-white text-sm sm:text-base transform transition-all duration-300 hover:bg-white hover:bg-opacity-20 hover:scale-105">
              ...
              <div className="pt-2 border-t border-white border-opacity-20">
                <p className="text-white font-semibold mb-2 flex items-center space-x-2">
                  <Sparkles
                    size={14}
                    className="text-white flex-shrink-0 sm:w-4 sm:h-4"
                  />
